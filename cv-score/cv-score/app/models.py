...
class Job(Base):
    ...
    jd_text = Column(Text)  # raw JD text
    jd_skills = Column(ARRAY(String))  # optional normalized skills
    jd_required_skills = Column(ARRAY(String))  # optional explicit required skills
    jd_preferred_skills = Column(ARRAY(String))  # optional explicit preferred skills
...
class Document(Base):
    ...
    type = Column(String)  # 'cv', 'cover', 'other'
    storage_uri = Column(String)  # placeholder; you can swap to S3
